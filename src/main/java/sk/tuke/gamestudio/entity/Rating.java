...
@NamedQueries({
        ...
        @NamedQuery(name = "Rating..update",
                query = "UPDATE Rating rating SET rating.rating = :rating, rating.ratedon = :ratedon WHERE rating.player = :player AND rating.game = :game")
})
public class Rating {
    @Id
    @GeneratedValue
